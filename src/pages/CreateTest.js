        ...
        <div className="title-container">
          ...
          <div className="options-section">
            <div className="option">
              ...
              <input required value={option1} onChange={(e)=>setOption1(e.target.value)} className='option-abc' placeholder="Option 1..."></input>
            </div>
            <div className="option">
              <p style={{color: "white"}}>B. </p>
              <input required value={option2} onChange={(e)=>setOption2(e.target.value)} className='option-abc' placeholder="Option 2..."></input>
            </div>
            <div className="option">
              <p style={{color: "white"}}>C. </p>
              <input required value={option3} onChange={(e)=>setOption3(e.target.value)} className='option-abc' placeholder="Option 3..."></input>
            </div>
            <div className="option">
              <p style={{color: "white"}}>D. </p>
              <input required value={option4} onChange={(e)=>setOption4(e.target.value)} className='option-abc' placeholder="Option 4..."></input>
            </div>
          </div>
